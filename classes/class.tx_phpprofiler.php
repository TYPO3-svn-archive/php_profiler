...
class tx_phpprofiler {
	...
	public function __construct() {		
		$this->profiler = new PhpQuickProfiler(PhpQuickProfiler::getMicroTime(), '/' . t3lib_extMgm::siteRelPath('php_profiler') . self::PQP_PATH);
		$this->db = t3lib_div::makeInstance('MySqlDatabase');
	}
	
	/**
	 * Get MySqlDatabse object
	 * 
